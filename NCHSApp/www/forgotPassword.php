...
<html>
    ...
    <form action="fPassword.php" method="post">
		<div style="margin-top: 40%; margin-bottom: 50%; margin-left: auto; margin-right: auto; border-radius: 15px; width: 80%; height: auto; background-color: white; text-align: center;">
			...
			<br>
            <input type="email" name="email" placeholder="E-Mail Address" style="width: 80%; height: 30px; background-color: black; color: white; border-radius: 15px; text-align: center; margin-left: auto; margin-right: auto;">
      		<br>
