...
<html>
  ...
  <?php
    if($isUserSet)
    {
        echo "<div style='overflow: hidden; margin-left: 25%; width: 50%; background-color: white; box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);'>
        <div style='float: left;'><b>Welcome, $Student</b></div><a href='logOut.php'><div style='float: right; color: #bf1d32;'><b>Sign Out</b></div></a></div>
    ...
    <div style='width: 95%; height: 30px; background-color: black; color: white; border-radius: 3px; margin-left: auto; margin-right: auto;'><button style='background-color: transparent; border: none; color:  white; width: 100%;' onclick='dropDown(\"classes\")'><b>Classes</b></button>
	</div>
    <div id='classes' style='width: 89%; height: auto; background-color: #bf1d32; display: none; margin-right: auto; margin-left: auto; text-align: center; border-bottom-left-radius: 3px; border-bottom-right-radius: 3px;'>
    ...
    <br>
    <div style='width: 95%; height: 30px; background-color: black; color: white; border-radius: 3px; margin-left: auto; margin-right: auto;'><button style='background-color: transparent; border: none; color:  white; width: 100%;' onclick='dropDown(\"teachers\")'><b>Teachers</b></button>
	</div>
